...
class Brand(models.Model):
    ...
    brand_name = models.CharField(
        verbose_name='Название бренда', max_length=255)
...
class ItemImage(models.Model):
    ...
    item = models.ForeignKey(
        verbose_name='', to=ShopItem, on_delete=models.CASCADE,
        related_name='images'
    )
...
class Cart(models.Model):
    ...
    shop_items = models.ManyToManyField(
        verbose_name='Продукт', to=ShopItem, blank=True, null=True
    )
